...
class CVCapture(QtCore.QObject):
    ...
    def start(self, *args):
        ...
        self.m_videoCapture = cv2.VideoCapture(0)#(self._index) ('rtsp://admin:Syergie123@123.45.0.13:554/Streaming/Channels/102')#
    ...
    def timerEvent(self, e):
        ...
        if (capture == 1):
            ...
            now = str(date.today())
            clock = str(strftime(' %H-%M-%S %p'))
            cv2.imwrite(now + clock+".png", frame)
            print(capture)
            capture = 0
